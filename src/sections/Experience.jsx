      ...
      <div className="w-full text-white-600">
        ...
        <div className="work-container">
          <div className="work-canvas">
            <Canvas>
              <ambientLight intensity={1} /> {/* Reduced from 7 to 0.7 */}
              <spotLight 
                position={[10, 10, 10]} 
                angle={0.15} 
                penumbra={1} // Added for softer edges
                intensity={0.5} // Added intensity control
              />
              <directionalLight position={[10, 10, 10]} intensity={0.5} />
              <OrbitControls 
                enableZoom={false} 
                maxPolarAngle={Math.PI / 2}
                enablePan={false} // Optional: disable panning for better UX
              />
